...
const iconPaths: Record<IconName, string> = {
  ...
  home: 'M4.5 11.4 12 4.7l7.5 6.7-1.3 1.5-1.2-1.1V19a1.5 1.5 0 0 1-1.5 1.5H8.5A1.5 1.5 0 0 1 7 19v-5.9l-1.2 1.1-1.3-1.5Zm4.5.8V19h2.5v-4.2h2V19H16v-6.8L12 8.3 9 12.2Z',
  search:
